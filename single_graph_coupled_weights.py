...
n_hidden1 = 300 #First embedding
n_hidden2 = 150  # smaller embeddings
n_hidden3 = n_hidden1
n_outputs = n_inputs
...
with tf.name_scope("phase2"):
    ...
    train_vars = [weights2, biases2, biases3]
...
with tf.Session() as sess:
    ...
    test_images(outputs_val,'first_loop_coupled')
    ...
    test_images(o,'second_loop_coupled')
