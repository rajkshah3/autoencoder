...
#Dropout and noise to enhance training data
...
#Gaus-sian noise
# noise_level=0.2
# X_doinised = tf.where(training,X + noise_level * tf.random_normal(tf.shape(X)),X)
#
dropout_rate = 0.1
X_doinised = tf.layers.dropout(X,dropout_rate,training=training)
...
hidden1 = my_dense_layer(X_doinised, n_hidden1)
